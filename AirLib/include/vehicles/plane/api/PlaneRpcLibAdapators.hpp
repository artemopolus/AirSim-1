...
#ifndef air_PlaneRpcLibAdapators_hpp
#define air_PlaneRpcLibAdapators_hpp
...
class PlaneRpcLibAdapators : public RpcLibAdapatorsBase {
public:
    struct YawMode {
        bool is_rate = true;
        float yaw_or_rate = 0;
    ...
    struct PlaneState {
        ...
        PlaneState(const msr::airlib::PlaneState& s)
        {
        ...
        msr::airlib::PlaneState to() const
        {
            return msr::airlib::PlaneState(collision.to(), kinematics_estimated.to(), 
