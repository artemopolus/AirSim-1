...
#ifndef msr_airlib_vehicles_Px4Plane_hpp
#define msr_airlib_vehicles_Px4Plane_hpp
...
namespace msr {
	namespace airlib {
		...
		class Px4PlaneParams : public PlaneParams {
		public:
			Px4PlaneParams(const AirSimSettings::MavLinkVehicleSetting& vehicle_setting, std::shared_ptr<const SensorFactory> sensor_factory)
			...
			virtual std::unique_ptr<PlaneApiBase> createPlaneApi() override
			{
